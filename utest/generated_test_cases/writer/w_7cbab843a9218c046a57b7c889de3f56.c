...
int main(void)
{
    ...
    assert(w.error_flags == BINSON_ID_OK);
    binson_write_string_with_len(&w, "\x14\x14\x14\x14\x14\x14\x14\x14\x14\x14\x14\x14\x14\x14\x14\x14\x7f\xef\xbf\xbd\x14\x14", 22);
    assert(w.error_flags == BINSON_ID_OK);
    binson_write_string_with_len(&w, "\x14\x14\x14\x14\x14\x14\x14\x14\x47\x14\x14\x13\xef\xbf\xbd\x14\x14\x14\x14\x14\x14\x14", 22);
    assert(w.error_flags == BINSON_ID_OK);
    ...
    assert(w.error_flags == BINSON_ID_OK);
    binson_write_string_with_len(&w, "\x14\x14\x14\x14\x14\x34\x14\x14\x14\x14\x14\x14\x14\x14\x14\x14\x01\x42\x10\x01", 20);
    assert(w.error_flags == BINSON_ID_OK);
    binson_write_string_with_len(&w, "\x43", 1);
    assert(w.error_flags == BINSON_ID_OK);
