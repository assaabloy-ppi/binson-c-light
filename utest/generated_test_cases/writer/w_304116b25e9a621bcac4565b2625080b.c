...
int main(void)
{
    uint8_t expected[130] = "";
    uint8_t created[130];
    binson_writer w;
    ...
    binson_write_integer(&w, 1);
    assert(w.error_flags == BINSON_ID_OK);
    binson_write_double(&w, 5.142912663207646E25);
    assert(w.error_flags == BINSON_ID_OK);
    binson_write_boolean(&w, false);
    assert(w.error_flags == BINSON_ID_OK);
    binson_write_boolean(&w, false);
