...
int main(void)
{
    uint8_t expected[141] = "";
    uint8_t created[141];
    binson_writer w;
    ...
    binson_write_boolean(&w, false);
    assert(w.error_flags == BINSON_ID_OK);
    binson_write_double(&w, 2.69083E-319);
    assert(w.error_flags == BINSON_ID_OK);
    binson_write_boolean(&w, false);
    assert(w.error_flags == BINSON_ID_OK);
    binson_write_boolean(&w, false);
