...
int main(void)
{
    uint8_t expected[147] = "";
    uint8_t created[147];
    binson_writer w;
    ...
    assert(w.error_flags == BINSON_ID_OK);
    binson_write_double(&w, 131056.0);
    assert(w.error_flags == BINSON_ID_OK);
    ...
    assert(w.error_flags == BINSON_ID_OK);
    binson_write_bytes(&w, (uint8_t *)"\x1e\x02", 2);
    assert(w.error_flags == BINSON_ID_OK);
    ...
    binson_write_string_with_len(&w, "\x43", 1);
    assert(w.error_flags == BINSON_ID_OK);
    binson_write_double(&w, 1.0173292736E10);
    assert(w.error_flags == BINSON_ID_OK);
    binson_write_object_begin(&w);
    assert(w.error_flags == BINSON_ID_OK);
    binson_write_object_end(&w);
