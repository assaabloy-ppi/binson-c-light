...
int main(void)
{
    ...
    assert(w.error_flags == BINSON_ID_OK);
    binson_write_string_with_len(&w, "\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x28\x30\x30\x30\x30", 20);
    assert(w.error_flags == BINSON_ID_OK);
    binson_write_name_with_len(&w, "\x30\x30\x30\x30\x30\x30\x30\x13\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30", 20);
    assert(w.error_flags == BINSON_ID_OK);
    binson_write_string_with_len(&w, "\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30", 20);
    assert(w.error_flags == BINSON_ID_OK);
