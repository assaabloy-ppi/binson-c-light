...
int main(void)
{
    uint8_t binson_bytes[223] = "";
    BINSON_PARSER_DEF(p);
    ...
    assert(binson_parser_go_into_object(&p));
    assert(p.error_flags == BINSON_ID_OK);
    assert(binson_parser_field_ensure_with_length(&p, "\x14\x14\x14\x14\x14\x14\x14\x14\x13\xef\xbf\xbd\x14\x14\x14\x14\x14\x14\x14\x14\x14\x14", 22, BINSON_TYPE_STRING));
    assert(p.error_flags == BINSON_ID_OK);
    rawval = binson_parser_get_string_bbuf(&p);
    assert(p.error_flags == BINSON_ID_OK);
    assert(memcmp(rawval->bptr, "\x14\x14\x14\x14\x14\x14\x14\x14\x14\x14\x14\x45\x45\x45\x45\x45\x45\x45\x45\x40", rawval->bsize) == 0);
